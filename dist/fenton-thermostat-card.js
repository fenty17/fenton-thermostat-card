      ...
      <div class="card">
          ...
          <div class="status-side">
            <div class="top-title-row">
              ...
              <span style="vertical-align:0.06em;white-space:nowrap;"
                >${null!==(t=e.title)&&void 0!==t?t:"Fenton Thermostat"}</span
              >
            </div>
        ...
        <div class="bottom-bar">
          ...
          <div class="boost-btns-area">
            <button class="boost-btn" @click=${()=>this._pressButton(e.boost_30_button)}>
              30m
            </button>
            <button
              class="boost-btn"
